...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../spi_wrapper.sopcinfo
...
# Design Name 
# setting SOPC_NAME is spi_wrapper
SOPC_NAME := spi_wrapper
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1479911908
SOPC_SYSID_FLAG += --timestamp=1479911908
ELF_PATCH_FLAG  += --timestamp 1479911908
